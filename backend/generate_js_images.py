#!/usr/bin/env python
"""
Illustrations pour le chapitre JavaScript (variables/types, conditions,
boucles, fonctions, tableaux, DOM, événements). Même style graphique que
...
OUT_DIR = "media/courses/javascript/section3"
...
if __name__ == "__main__":
    ...
    print("\n✨ 7 illustrations générées dans", OUT_DIR)
